...
1. Log in to `https://chat.fpt.com` in a browser.
2. F12 → **Network** → click any request to `api-chat.fpt.com`.
...
```
python auth.py qr-generate            # -> QR token (render/scan with FPT Chat mobile app)
